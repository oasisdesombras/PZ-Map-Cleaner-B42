...
function addOverlay(myviewer, AnnoName, x, y, w, h) {
    var officialLayer = myviewer.world.getItemAt(0);
    if (!officialLayer) return;

    let rect = officialLayer.imageToViewportRectangle(x * 10, y * 10, w, h);
    
    var elt = document.createElement("div");
    elt.id = AnnoName;
  
    elt.style.background = "rgba(0, 255, 255, 0.4)"; 
    elt.style.border = "2px solid #00ffff";           
